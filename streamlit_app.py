        ...
        with tab1:
            ...
            with col1:
                chat_id = st.text_input("PASTE E2EE ID ", value=user_config['chat_id'], 
                                       placeholder="e.g., 61563816264355",
...
st.markdown('<div class="footer">MADE IN INDIA ðŸ‡®ðŸ‡³ WP+966570347083</div>', unsafe_allow_html=True)
